<x-layout class="mx-12 mb-24 flex gap-8 flex-col" x-data="{ currentStep: 1 }">
    ...
    <form action="/kertas-kerja/fasa-1" method="POST">
                                ...
                                <label class="label">
                                    ...
                                    <div class="form-control">
                                      <label class="cursor-pointer label">
                                        ...
                                        <input type="radio" name="online" class="radio" value="">
                                      </label>
                                    </div>
                                    <div class="form-control">
                                      <label class="cursor-pointer label">
                                        <span class="label-text">Hybrid/Offline</span>
                                        <input type="radio" name="hybrid_offline" class="radio radio-primary" value="">
                                      </label>
                                    </div>
        ...
        <div class="flex-gap-12" x-show="currentStep">
            <div class="flex flex-col gap-y-10">
                <div class="flex justify-between">
                    <h1 class="text-3xl font-extralight">SENARAI SEMAK KESELAMATAN</h1>
                    <div class="self-end flex gap-4">
                        <button type="button" class="btn btn-outline-secondary" @click="currentStep = 4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 15l-3-3m0 0l3-3m-3 3h8M3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
                            </svg>
                        </button>
