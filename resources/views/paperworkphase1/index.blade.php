...
<x-layout class="mx-12 flex gap-12 min-h-full" style="min-height: 70vh;">
    ...
    <div class="flex-grow">
        <a href="/kertas-kerja/fasa-1/permohonan" class="btn-block btn btn-lg btn-primary"><span class="mr-3">Mohon</span> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
